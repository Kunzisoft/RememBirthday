...
public abstract class ActionBirthdayInDatabaseTask extends AsyncTask<Void, Void, Exception> {
     ...
     */
    public static class AddBirthdayToContactTask extends ActionBirthdayInDatabaseTask {
     ...
     * AsyncTask who store the birthday in database for a specific contact
     */
    public static class RemoveBirthdayFromContactTask extends ActionBirthdayInDatabaseTask {
    ...
    public static class UpdateBirthdayToContactTask extends ActionBirthdayInDatabaseTask{
